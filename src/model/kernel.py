...
class Kermut_reduced(Kernel):
    """
    K(x,x') = k_hn(x,x') * k_bl(x,x')
    where
    k_hn(x,x') = h_scale * exp(-h_lengthscale * d_hn(x,x'))
    k_bl(x,x') = (bl_src * bl_tar) (BLOSUM score between sources and targets)
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(Kermut_reduced, self).__init__()
...
class Kermut_distance(Kernel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(Kermut_distance, self).__init__()
...
class Kermut_distance_no_blosum(Kernel):
    def __init__(
        self,
        conditional_probs: torch.Tensor,
        wt_sequence: torch.LongTensor,
        ...
        **kwargs,
        ...
        super(Kermut_distance_no_blosum, self).__init__()
