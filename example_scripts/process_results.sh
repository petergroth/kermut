...
python kermut/process_results/merge_score_files.py
...
python kermut/process_results/performance_DMS_supervised_benchmarks.py \
...
python kermut/process_results/merge_score_files.py --ablation
python kermut/process_results/performance_DMS_supervised_benchmarks.py \
